...
import org.tuiasi.engine.ui.components.basicComponents.searchbar.ISearchbar;
...
public class FileDialog extends IComponent {
    ...
    public FileDialog(String label, DialogType dialogType, SearchbarWithHint relatedSearchbar) {
        this.label = label;
